describe('numbers', () => {
  describe('binary operations', () => {
    it('you should be able to find the value of a given bit', () => {
    ...
    it('you should be able to return the base10 representation of a binary string', () => {
      expect(numbersAnswers.base10('11000000')).to.eql(192);
    });

    it('you should be able to convert an eight-bit number to a binary string', () => {
  ...
  describe('decimals', () => {
    it('you should be able to multiply with precision', () => {
