describe('functions', () => {
  ...
  it('you should be able to apply functions with arbitrary numbers of arguments', () => {
    (function iiife() {
      ...
      const iTake2Arguments = function iTake2Arguments(firstArgument, secondArgument) {
      ...
      const iTake3Arguments = function iTake3Arguments(first, second, third) {
  ...
  it('you should be able to create a "partial" function for variable number of applied arguments', () => {
    const partialMe = function partialMe(x, y, z) {
      return (x / y) * z;
    };
  ...
  it('you should be able to curry existing functions', () => {
    const curryMe = function curryMe(x, y, z) {
      return (x / y) * z;
    };
